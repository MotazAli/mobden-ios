...
struct HighSchoolHomeView: View {
    ...
    @State var honorBoardID : Int = 0
       ...
       var newsUrl = "assets/images/news/"
               ...
               init() {
                   ...
                   self.articleModel.getTopThreeArticleByStage(id: 3)
                   self.newsModel.getThreeNewsByStage(id: 3)
                self.honorBoardModel.getHonorBoardByStage(id: 3)
                  ...
                  var body: some View {
                   ...
                   NavigationView{
                       ...
                       //Group{
                           ...
                           VStack{
                               NavigationLink(destination: ArticlesView(stageId: 3)){
                                   HStack{
                      ...
                      // Group{
                           ...
                           VStack{
                               NavigationLink(destination: NewsView(stageID: 3)){
                                   HStack{
                                       Text("شاهد الكل").foregroundColor(Color.blue)
                                       Spacer()
                           ...
                           VStack{
                              NavigationLink(destination: HonorBoardView(stageId: 3)){
                                   HStack{
                                       Text("شاهد الكل").foregroundColor(Color.blue)
                                       Spacer()
...
struct HighSchoolHomeView_Previews: PreviewProvider {
